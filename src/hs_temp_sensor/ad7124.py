...
class AD7124:
    ...
    def read_die_temp(self):
        self.spi.xfer2([AD7124_COMMS_REG | AD7124_COMM_REG_WEN| AD7124_COMM_REG_WR | AD7124_COMM_REG_RA(AD7124_CH0_MAP_REG)])
        set_ch0 = AD7124_CH_MAP_REG_CH_ENABLE | AD7124_CH_MAP_REG_SETUP(0) | AD7124_CH_MAP_REG_AINP(0x10) | AD7124_CH_MAP_REG_AINN(0x10)
        self.spi.xfer2([(set_ch0 >> 8) & 0xFF, set_ch0 & 0xFF])
